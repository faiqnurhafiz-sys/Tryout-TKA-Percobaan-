const dataMatematika = {
    ...
    questions: [
        ...
        {
            id: 'm5_p1',
            stimulus: "Panjang telapak kaki $x$ (cm) memiliki ukuran EU: $f(x) = x + 13.5$. Konversi EU ke US/UK: $g(y) = y - 33$ (US) atau $y - 30.5$ (UK).<br>Toko A (kaki terkecil 21 cm), Toko B (21.5 cm), Toko C (23 cm), Toko D (24 cm).",
            question: "Aldi membeli sepatu ukuran 4.5 (lupa US atau UK). Di toko manakah Aldi pasti dapat membeli sepatu sneakers tersebut?",
        ...
        {
            id: 'm8_p1',
            stimulus: "<pre>\nModel A                     Model B\n+------------------+        +------------------+\n|  /\\      /\\      |        |  /\\      /\\      |\n| /  \\====/  \\     |        | /  \\====/  \\     |\n|/  |  ||  |  \\    |        |/  |  ||  |  \\    |\n||  |  ||  |  |    |        ||  |  ||  |  |    |\n||  [__] [__] |    |        ||  |  ||  |  |    |\n|\\____________/    |        |\\____________/    |\n+------------------+        +------------------+\n- 1,5m kain hitam           - 1m kain hitam\n- 1,5m kain putih           - 2m kain putih\nPersediaan: 30m kain hitam, 40m kain putih\n</pre>",
            question: "Jika $x$ adalah kemeja model A dan $y$ kemeja model B, model matematika yang sesuai adalah...",
            options: [
                "3x + 2y <= 60; 3x + 4y <= 80; x >= 0; y >= 0",
                "3x + 2y <= 80; 3x + 4y <= 60; x >= 0; y >= 0",
                "3x + 3y <= 60; x + 2y <= 80; x >= 0; y >= 0",
                "3x + 2y <= 80; 3x + 4y <= 60; x >= 0; y >= 0",
                "1.5x + y <= 40; 1.5x + 2y <= 30; x >= 0; y >= 0"
            ],
            correct: 0,
        ...
        {
            id: 'm9_p1',
            stimulus: "Paket A (2 Cokelat + 2 Vanilla + 2 Strawberry) = Rp88.000<br>Paket B (1 Cokelat + 3 Vanilla + 2 Strawberry) = Rp76.000<br>Paket C (1 Cokelat + 1 Vanilla + 2 Strawberry) = Rp49.000",
            question: "Berapakah total harga jika membeli Paket A, ditambah 1 cupcake vanilla dan 2 cupcake strawberry?",
        ...
        },
        {
            id: 'm10_p1',
            stimulus: "<pre>\n       H +--------------+ G\n        /|             /|\n       / |            / |\n      E +--------------+ F|\n      |  |           |  |\n      |  D +---------|--+ C\n      | /            | /\n      |/             |/\n      A +------------+ B\n</pre>",
            question: "Pada kubus/balok $ABCD.EFGH$, sudut manakah yang besarnya sama dengan $\\angle B$ (90 derajat)?",
            options: ["∠A, ∠C, ∠D, ∠E, ∠F", "∠A dan ∠C saja", "∠E dan ∠F saja", "∠D saja", "Tidak ada"],
            correct: 0,
        ...
        },
        {
            ...
            options: ["ABCD, CDHG, ADHE, ABFE", "ABCD saja", "EFGH saja", "ADHE saja", "Tidak ada"],
            correct: 0,
